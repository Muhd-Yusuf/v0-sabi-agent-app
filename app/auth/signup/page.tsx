    ...
    <div className="space-y-6">
      ...
      <div className="text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-baby-green/50 border border-primary/10 mb-6">
          ...
          <span className="text-xs font-semibold text-primary">Start for free</span>
        </div>
        <h1 className="text-3xl sm:text-4xl font-extrabold text-foreground mb-3 tracking-tight">
          Create your account
        </h1>
        <p className="text-muted-foreground">
          Join <span className="font-semibold text-foreground">150+</span> African SMEs growing with Sabi Agent
        </p>
      </div>
        ...
        <div className="space-y-2">
          ...
          {password && (
            <div className="space-y-2">
              ...
              <p className={`text-xs font-medium ${passwordStrength.strength <= 1 ? "text-red-500" :
                  passwordStrength.strength <= 2 ? "text-orange-500" :
                    passwordStrength.strength <= 3 ? "text-yellow-600" : "text-primary"
                }`}>
        ...
        <div className="space-y-2">
          ...
          <div className="relative group">
            <input
              ...
              className={`w-full px-4 py-3.5 pr-12 rounded-xl border-2 bg-white text-foreground placeholder:text-muted-foreground/60 focus:outline-none focus:ring-4 transition-all duration-200 ${confirmPassword && password !== confirmPassword
        ...
        <div className="flex items-start gap-3">
          <div className="relative flex items-center">
            <input
              ...
              className="w-5 h-5 rounded-md border-2 border-border text-primary focus:ring-primary/20 focus:ring-offset-0 cursor-pointer"
            />
          </div>
